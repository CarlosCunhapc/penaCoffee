...
import static com.example.penacoffee.domain.PaymentAsserts.*;
import static com.example.penacoffee.web.rest.TestUtil.createUpdateProxyForBean;
import static com.example.penacoffee.web.rest.TestUtil.sameNumber;
import static org.assertj.core.api.Assertions.assertThat;
import static org.hamcrest.Matchers.hasItem;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.*;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import com.example.penacoffee.IntegrationTest;
import com.example.penacoffee.domain.Order;
import com.example.penacoffee.domain.Payment;
import com.example.penacoffee.domain.enumeration.PaymentMethod;
import com.example.penacoffee.repository.PaymentRepository;
import com.example.penacoffee.service.dto.PaymentDTO;
import com.example.penacoffee.service.mapper.PaymentMapper;
...
class PaymentResourceIT {
    ...
    public static Payment createEntity(EntityManager em) {
        Payment payment = new Payment().paymentDate(DEFAULT_PAYMENT_DATE).amount(DEFAULT_AMOUNT).paymentMethod(DEFAULT_PAYMENT_METHOD);
        // Add required entity
        Order order;
    ...
    public static Payment createUpdatedEntity(EntityManager em) {
        Payment payment = new Payment().paymentDate(UPDATED_PAYMENT_DATE).amount(UPDATED_AMOUNT).paymentMethod(UPDATED_PAYMENT_METHOD);
        // Add required entity
        Order order;
        if (TestUtil.findAll(em, Order.class).isEmpty()) {
