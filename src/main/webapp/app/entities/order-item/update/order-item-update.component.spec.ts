...
describe('OrderItem Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Product query and add missing value', () => {
      ...
      const product: IProduct = { id: 19341 };
      orderItem.product = product;

      const productCollection: IProduct[] = [{ id: 27610 }];
    ...
    it('Should call Order query and add missing value', () => {
      const orderItem: IOrderItem = { id: 456 };
      const order: IOrder = { id: 14492 };
      orderItem.order = order;

      const orderCollection: IOrder[] = [{ id: 1958 }];
    ...
    it('Should update editForm', () => {
      const orderItem: IOrderItem = { id: 456 };
      const product: IProduct = { id: 1085 };
      orderItem.product = product;
      const order: IOrder = { id: 5586 };
      orderItem.order = order;
